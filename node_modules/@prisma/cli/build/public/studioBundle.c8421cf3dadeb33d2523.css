...
.dialog__container___3ja9Z{z-index:var(--z-index--dialog);position:absolute;top:0;bottom:0;left:0;right:0;margin:5vh auto auto auto;transform:translate(-50%, -50%);width:300px;height:300px;background-color:var(--white);box-shadow:var(--shadow-bold);border-radius:8px;overflow:hidden;animation:var(--animation-fadeInTop);animation-fill-mode:both;will-change:transform}.dialog__closeButton___2K5Cs{position:absolute;top:3px;right:3px}

.tab-close-confirm-dialog__container___39fyK{display:flex;flex-direction:column;padding:10px;height:170px;width:450px}.tab-close-confirm-dialog__content___vDOEo{flex:1}.tab-close-confirm-dialog__title___2uUVs{font-size:14px;font-weight:600;margin-top:10px}.tab-close-confirm-dialog__subtitle___20VoJ{background-color:var(--gray-300);color:var(--gray-800);font-size:12px;border-radius:4px;padding:10px;flex:1;margin:20px 0}.tab-close-confirm-dialog__footer___1rkzP{display:flex;flex-direction:row-reverse}.tab-close-confirm-dialog__footer___1rkzP .tab-close-confirm-dialog__discardBtn___8D_yb{background-color:var(--red-500)}

.tab__container___3Kpmb{display:flex;align-items:center;height:32px;max-width:250px;padding:0 6px;cursor:pointer;border-right:1px solid var(--gray-400);-webkit-app-region:no-drag}.tab__container___3Kpmb:hover{opacity:1}.tab__container___3Kpmb:hover .tab__title___2ul-B{opacity:1}.tab__container___3Kpmb.tab__active___KKPVa{background-color:var(--white);box-shadow:var(--shadow-bold);opacity:1}.tab__container___3Kpmb.tab__active___KKPVa .tab__title___2ul-B{opacity:1}.tab__container___3Kpmb.tab__preview___1Ggra .tab__title___2ul-B{font-style:italic}.tab__modelListTabIcon___3Kc_-{padding:0 5px}.tab__modelListTabIcon___3Kc_- svg{width:10px;height:10px;opacity:0.5;color:var(--gray-800)}.tab__title___2ul-B{flex:1;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;font-size:var(--font-size-normal);font-weight:600;padding:0 6px;opacity:0.5;color:var(--gray-800)}.tab__closeButton___1ZYuG{padding:0px;opacity:0.25;width:14px;height:22px;cursor:pointer}.tab__closeButton___1ZYuG:hover{opacity:1}.tab__closeButton___1ZYuG svg{width:12px;height:12px;fill:var(--gray-600);transform:rotate(45deg)}.tab__closeButton___1ZYuG .tab__dirtyIndicator___21LsQ{width:10px;height:10px;background-color:var(--gray-600);border-radius:50%}

.tab-bar__container___39AMi{display:flex;align-items:center;flex:1;margin-left:16px;border-left:1px solid var(--gray-400);overflow-x:auto;overflow-y:hidden;scrollbar-color:var(--gray-500) transparent;scrollbar-width:thin}.tab-bar__container___39AMi::-webkit-scrollbar{width:2em;height:4px}.tab-bar__container___39AMi::-webkit-scrollbar-track{background:transparent}.tab-bar__container___39AMi::-webkit-scrollbar-thumb{background-color:var(--gray-500);border-radius:20px;border:none}
...
.error-dialog__container___pEH_e{width:90%;height:auto;max-height:90%;padding:30px;display:flex;flex-direction:column}.error-dialog__container___pEH_e.error-dialog__fullscreen___2NzEq{position:fixed;top:0;bottom:0;left:0;right:0;height:100vh;max-height:100vh;width:100vw;transform:initial;margin:initial}.error-dialog__header___EXidN{display:flex;align-items:center}.error-dialog__header___EXidN .error-dialog__title___2wop9{flex:1;color:var(--red-600);font-size:18px;font-weight:600}.error-dialog__dump___KYbsJ{background-color:var(--red-100);color:var(--red-600);border-radius:8px;flex:1;padding:20px;overflow:auto;user-select:text}.error-dialog__trace___1g7Ee .error-dialog__toggleTraceButton___2Gt7S{opacity:1;font-weight:600;color:var(--gray-900);justify-content:flex-start}.error-dialog__trace___1g7Ee .error-dialog__toggleTraceButton___2Gt7S svg{width:24px;height:24px;fill:var(--gray-900);transition:transform 0.3s}.error-dialog__trace___1g7Ee .error-dialog__toggleTraceButton___2Gt7S.error-dialog__open___2vYxB svg{transform:rotate(90deg)}.error-dialog__trace___1g7Ee .error-dialog__traceText___23JHu{font-family:var(--font-family);padding:0 40px;margin:0;margin-bottom:10px;user-select:text}

:root{--white: #fff;--black: #000;--studio: #9f6bf4;--studio-dark: #8044e2;--gray-100: #f7fafc;--gray-200: #edf2f7;--gray-300: #e2e8f0;--gray-400: #cbd5e0;--gray-500: #a0aec0;--gray-600: #718096;--gray-700: #4a5568;--gray-800: #2d3748;--gray-900: #1a202c;--green-100: #eefef3;--green-200: #bff4cf;--green-300: #90e2ab;--green-400: #5ecd87;--green-500: #3fb36d;--green-600: #31965e;--green-700: #297a4f;--green-800: #245c40;--green-900: #1e4b36;--blue-100: #ebf8ff;--blue-200: #bee3f8;--blue-300: #90cdf4;--blue-400: #63b3ed;--blue-500: #4299e1;--blue-600: #3182ce;--blue-700: #2b6cb0;--blue-800: #2c5282;--blue-900: #2a4365;--red-100: #fff3f3;--red-200: #fed1d2;--red-300: #fea8a9;--red-400: #fc7575;--red-500: #f35a5a;--red-600: #e13637;--red-700: #be2a2a;--red-800: #902727;--red-900: #692526;--yellow-100: #ffffed;--yellow-200: #fefbb8;--yellow-300: #faed7f;--yellow-400: #f5db54;--yellow-500: #e9c241;--yellow-600: #d09329;--yellow-700: #af6e1d;--yellow-800: #8c4f16;--yellow-900: #683a12}@keyframes script-error__slideInTop___12L6D{0%{transform:translateY(-50px)}100%{transform:translateY(0px)}}.script-error__container___3-qs3{display:flex;align-items:center;background-color:var(--red-100);box-shadow:3px 4px 8px rgba(45,55,72,0.05),3px 1px 3px rgba(45,55,72,0.05);padding:0 10px;position:fixed;width:100%;height:50px;animation-name:script-error__slideInTop___12L6D;animation-duration:0.3s;animation-fill-mode:forwards;z-index:var(--z-index--script-error)}.script-error__closeButton___34pF7{padding:0;margin-right:15px;color:var(--red-600)}.script-error__closeButton___34pF7 svg,.script-error__closeButton___34pF7:active svg{width:14px;height:14px;fill:var(--red-600);transform:rotate(45deg);margin-right:5px}.script-error__content___Banj9{flex:1;display:flex;align-items:center;height:100%;cursor:pointer}.script-error__content___Banj9 .script-error__title___1Pqi7,.script-error__content___Banj9 .script-error__subtitle___2Ish8{font-weight:600;color:var(--red-600)}.script-error__content___Banj9 .script-error__subtitle___2Ish8{margin-left:7px;font-weight:400}
...
.fatal-error__dialog___2e9jL{height:750px;width:700px;transition:height var(--transition-normal);will-change:height}.fatal-error__container___1ikgw{height:100%;background-color:var(--white);display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:30px}.fatal-error__image___2Jyar{transition:all var(--transition-normal);max-height:300px;margin-bottom:50px}.fatal-error__image___2Jyar.fatal-error__isDetailsOpen___2remK{max-height:0;margin-bottom:0}.fatal-error__title___14r-A{font-size:22px;font-weight:600;margin-bottom:20px;color:var(--gray-800)}.fatal-error__subtitle___3im0P{font-size:14px;font-weight:400;margin-bottom:40px;max-width:450px;text-align:center;color:var(--gray-600)}.fatal-error__telemetryButton___3s4Hg,.fatal-error__githubButton___1sykH{background-color:var(--studio);font-size:14px;padding:15px;margin-bottom:20px;box-shadow:var(--shadow-normal)}.fatal-error__telemetryButton___3s4Hg:hover,.fatal-error__githubButton___1sykH:hover{background-color:var(--studio);box-shadow:var(--shadow-bold)}.fatal-error__telemetryButton___3s4Hg:active,.fatal-error__githubButton___1sykH:active{background-color:var(--studio-dark)}.fatal-error__githubButton___1sykH{border-radius:3px;color:var(--white);text-decoration:none;font-weight:600}.fatal-error__githubButton___1sykH:active{color:var(--white)}.fatal-error__githubButton___1sykH:visited{color:var(--white)}.fatal-error__reopenButton___3pXoX,.fatal-error__clearAndReopenButton___1v37q{background-color:transparent !important;box-shadow:none !important;color:var(--gray-600);font-size:14px;font-weight:400;padding:15px;margin-bottom:20px}.fatal-error__reopenButton___3pXoX span,.fatal-error__clearAndReopenButton___1v37q span{text-decoration:underline}.fatal-error__reopenButton___3pXoX{margin-bottom:0}.fatal-error__toggleDetailsButton___1fnrm{opacity:1;font-weight:600;color:var(--gray-600);justify-content:flex-start}.fatal-error__toggleDetailsButton___1fnrm.fatal-error__open___1wy8r svg{transform:rotate(90deg)}.fatal-error__toggleDetailsButton___1fnrm svg{width:24px;height:24px;fill:var(--gray-600);transition:transform 0.3s}.fatal-error__dump___1sYCO{text-align:left;background-color:var(--red-100);color:var(--red-600);border-radius:8px;flex:1;width:100%;padding:20px;overflow:auto;user-select:text;white-space:pre-wrap}
...
.dropdown-menu__container___hBvHv{border-radius:4px;background-color:var(--gray-700);box-shadow:var(--shadow-bold);display:flex;flex-direction:column;padding:5px 0;outline:none;position:absolute;z-index:var(--z-index--dropdown)}.dropdown-menu__item___8IXYS{display:flex;align-items:center;padding:5px 15px;cursor:pointer;white-space:nowrap;color:var(--white)}.dropdown-menu__item___8IXYS:hover,.dropdown-menu__item___8IXYS.dropdown-menu__highlighted___3AzXm{background-color:var(--gray-800)}.dropdown-menu__item___8IXYS svg{width:12px;height:12px;margin-right:10px}

.dropdown__label___YgdfJ{display:block;color:var(--gray-900);font-size:12px;font-weight:600;margin-right:5px;margin-bottom:10px}.dropdown__button___3xS77{border-radius:4px;display:flex;align-items:center;justify-content:center;cursor:pointer;position:relative}.dropdown__button___3xS77:hover,.dropdown__button___3xS77.dropdown__open___-e2ns{background-color:var(--gray-200)}.dropdown__button___3xS77.dropdown__open___-e2ns{display:flex !important}.dropdown__button___3xS77 svg{width:24px;height:24px;fill:var(--gray-600)}.dropdown__textButton___sGVgo{flex:1;display:flex;align-items:center;padding:10px 15px;background-color:var(--gray-200);border-radius:4px}.dropdown__textButton___sGVgo span{flex:1}.dropdown__caret___1qGs0{flex:0 0 8px;height:8px;border-right:2px solid var(--gray-600);border-bottom:2px solid var(--gray-600);transform:rotate(45deg);margin-left:10px;margin-right:5px}.dropdown__dropdown___1Vyuu{margin-top:10px}

.where-filter__whereContainer___3UaZ6{display:flex;flex-direction:column;align-items:flex-start}.where-filter__rowContainer___2PYYW{display:flex;align-items:center;flex-wrap:nowrap;padding:8px;border-bottom:1px solid var(--gray-800);position:relative}.where-filter__rowContainer___2PYYW:first-child{border-radius:4px}.where-filter__rowContainer___2PYYW.where-filter__invalid___33BWy{background-color:var(--red-800)}.where-filter__rowContainer___2PYYW .where-filter__deleteButton___1O7H5{opacity:0.5;padding:0;margin:0 0 0 8px}.where-filter__rowContainer___2PYYW .where-filter__deleteButton___1O7H5:hover{opacity:1}.where-filter__rowContainer___2PYYW .where-filter__deleteButton___1O7H5 svg{width:12px;height:12px;fill:var(--white);transform:rotate(45deg)}.where-filter__empty___39mI7{color:var(--gray-500);width:335px;margin:12px 16px 8px;line-height:1.4}.where-filter__addButton___1ruqz{margin:8px}.where-filter__tooltip___2-WH1{display:flex;flex-direction:column;background-color:var(--gray-700);box-shadow:var(--shadow-normal);border-radius:4px}.where-filter__tooltip___2-WH1 .where-filter__button___1jfJa{white-space:nowrap;border-radius:3px;height:24px;font-size:12px;line-height:24px;padding:0 8px;margin:0 4px;background-color:var(--gray-800);color:var(--white)}.where-filter__fieldDropdown___-2zJa,.where-filter__operationDropdown___XuSzX{background-color:transparent !important}.where-filter__fieldDropdown___-2zJa>div,.where-filter__operationDropdown___XuSzX>div{height:24px;font-size:12px;margin:0 4px;padding:10px;background-color:var(--gray-800);color:var(--white)}.where-filter__fieldDropdown___-2zJa>div>div,.where-filter__operationDropdown___XuSzX>div>div{height:6px;flex:0 0 6px}.where-filter__fieldDropdown___-2zJa:hover>div,.where-filter__operationDropdown___XuSzX:hover>div{background-color:var(--gray-900)}.where-filter__input___33AvP{flex:1;margin-left:4px}.where-filter__input___33AvP input{flex:0 0 24px;border-radius:3px;font-size:12px;font-family:var(--font-family--code);padding:0 8px;background-color:var(--gray-800);color:var(--white);width:190px}.where-filter__input___33AvP input::placeholder{color:var(--gray-500)}.where-filter__input___33AvP input:focus{background-color:var(--gray-900)}

.common__container___v9Z4o{display:flex;align-items:center;margin-right:10px;cursor:pointer}.common__button___1lK9k{display:flex;justify-content:center;align-items:center;font-size:12px;white-space:nowrap;border-radius:4px;overflow:hidden;background-color:var(--gray-300);box-shadow:var(--shadow-button);transition:var(--transition-normal)}.common__button___1lK9k>span{line-height:16px;display:inline-block;padding:4px 8px;color:var(--gray-600)}.common__button___1lK9k>span.common__label___3Krp2{background:var(--gray-400);font-weight:600;box-shadow:var(--shadow-button);color:var(--gray-900);transition:var(--transition-normal)}.common__button___1lK9k.common__open___3fMuY,.common__button___1lK9k:hover{background-color:var(--gray-400)}.common__button___1lK9k.common__open___3fMuY>span,.common__button___1lK9k:hover>span{color:var(--gray-700)}.common__button___1lK9k.common__open___3fMuY>span.common__label___3Krp2,.common__button___1lK9k:hover>span.common__label___3Krp2{background-color:var(--gray-500);color:var(--black)}.common__button___1lK9k.common__exists___2kUqF{background-color:var(--yellow-300)}.common__button___1lK9k.common__exists___2kUqF>span{color:var(--yellow-700)}.common__button___1lK9k.common__exists___2kUqF>span.common__label___3Krp2{background-color:var(--yellow-400);color:var(--yellow-900)}
...
.field-filter__tooltip___3ggWg{display:grid;grid-template-columns:min-content 1fr min-content;grid-auto-rows:min-content;background-color:var(--gray-700);box-shadow:var(--shadow-normal);border-radius:5px;padding:8px}.field-filter__search___3KyTd{grid-column:2 / -1}.field-filter__search___3KyTd input{flex:0 0 24px;border-radius:3px;font-size:12px;padding:0 8px;margin-bottom:4px;margin-left:4px;background-color:var(--gray-800);color:var(--white)}.field-filter__search___3KyTd input::placeholder{color:var(--gray-500)}.field-filter__search___3KyTd input:focus{background-color:var(--gray-900)}.field-filter__checkbox___1xjjC div:first-child{width:16px;height:16px;border-radius:3px;background-color:var(--gray-800)}.field-filter__checkbox___1xjjC:hover div:first-child{border:0;background-color:var(--gray-900)}.field-filter__name___1VWps{color:var(--white);font-size:13px;margin-left:5px;white-space:nowrap;cursor:pointer}.field-filter__name___1VWps:hover{opacity:0.8}.field-filter__type___1nlfj{margin-left:40px;color:var(--gray-500);white-space:nowrap;text-align:right;cursor:pointer;margin-right:5px}

.pagination-filter__text___S7_Tb{font-size:12px;line-height:24px;color:var(--white);margin-right:3px}.pagination-filter__separator___3_Ts0{margin:0 2px}.pagination-filter__tooltip___3d1E_{display:flex;background-color:var(--gray-700);box-shadow:var(--shadow-normal);border-radius:5px;padding:8px}.pagination-filter__tooltip___3d1E_ .pagination-filter__tooltipBody___3ovSD{display:flex}.pagination-filter__input___32x5L{width:60px}.pagination-filter__input___32x5L input{flex:0 0 24px;border-radius:3px;font-size:12px;padding:0 8px;margin-bottom:4px;background-color:var(--gray-800);color:var(--white)}.pagination-filter__input___32x5L input::placeholder{color:var(--gray-600)}.pagination-filter__input___32x5L input:focus{background-color:var(--gray-900)}

.readonly-dialog__dialog___fRVg0{width:500px;height:500px}.readonly-dialog__container___1Yr4K{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:50px}.readonly-dialog__illustration___1kF0d{height:200px;width:auto;margin-bottom:40px}.readonly-dialog__title___3FBm-{font-size:22px;font-weight:600;margin-bottom:20px;color:var(--gray-800);margin-bottom:20px}.readonly-dialog__content___3wMXN{font-size:14px;font-weight:400;margin-bottom:40px;max-width:450px;text-align:center;color:var(--gray-600);margin-bottom:40px}.readonly-dialog__confirmButton___2z6Tg{background-color:var(--studio);font-size:14px;padding:15px;margin-bottom:20px;box-shadow:var(--shadow-normal)}.readonly-dialog__confirmButton___2z6Tg:hover{box-shadow:var(--shadow-bold)}.readonly-dialog__confirmButton___2z6Tg:active{background-color:var(--studio-dark)}

.pending-actions__container___rRrZt{display:flex;justify-content:flex-start}.pending-actions__separator___PdyAh{width:1px;background:var(--gray-300);align-self:stretch;margin-left:6px}.pending-actions__action___vs1zx{margin-left:10px}.pending-actions__action___vs1zx.pending-actions__discardBtn___3G48w{text-decoration:underline}.pending-actions__action___vs1zx.pending-actions__confirmBtn___11W0g{background-color:var(--green-600)}

.table-empty-overlay__container___aqyso{padding-left:44px;padding-top:89px;width:inherit;height:inherit;text-align:left;font-family:var(--font-family);color:var(--gray-500);font-weight:600}

.type-icon__icon___do9KN{width:10px;height:10px;flex:0 0 10px;fill:var(--gray-500)}

.table-cell-header__container___13mm4{background:var(--white);display:flex;align-items:center;height:var(--table-header-row-height);padding:0 12px;height:inherit;font-family:var(--font-family);overflow:hidden}.table-cell-header__container___13mm4.table-cell-header__sortable___2yeLr{cursor:pointer}.table-cell-header__title___EPFko{margin-right:8px;overflow:hidden;text-overflow:ellipsis}.table-cell-header__sortIndicator___PH7Pn{display:none;margin-left:5px;fill:var(--gray-500);width:20px;height:20px;flex:0 0 20px}.table-cell-header__sortIndicator___PH7Pn.table-cell-header__visible___1Cp2G{display:flex}.table-cell-header__sortIndicator___PH7Pn.table-cell-header__asc___2pqml{transform:rotate(-90deg)}.table-cell-header__sortIndicator___PH7Pn.table-cell-header__desc___3ke4p{transform:rotate(90deg)}

.table-cell-renderer__container___3m_v3{overflow:hidden;text-overflow:ellipsis;align-items:center;padding:0 12px;height:var(--table-row-height)}.table-cell-renderer__container___3m_v3.table-cell-renderer__dirty___3CwdP{background-color:var(--yellow-200)}.table-cell-renderer__container___3m_v3.table-cell-renderer__invalid___Km2Ng{background-color:var(--red-200)}.table-cell-renderer__container___3m_v3.table-cell-renderer__placeholder___Qs3DS,.table-cell-renderer__container___3m_v3.table-cell-renderer__null___yOhwv{color:var(--gray-500);font-style:italic}.table-cell-renderer__container___3m_v3.table-cell-renderer__placeholder___Qs3DS .table-cell-renderer__relationPill___2W48j,.table-cell-renderer__container___3m_v3.table-cell-renderer__null___yOhwv .table-cell-renderer__relationPill___2W48j{background-color:var(--white);border:1px solid var(--gray-200);font-style:normal;color:var(--gray-500)}.table-cell-renderer__container___3m_v3.table-cell-renderer__placeholder___Qs3DS .table-cell-renderer__relationPill___2W48j>span,.table-cell-renderer__container___3m_v3.table-cell-renderer__null___yOhwv .table-cell-renderer__relationPill___2W48j>span{box-shadow:none}.table-cell-renderer__container___3m_v3.table-cell-renderer__relation___2WsvF{display:flex}.table-cell-renderer__relationPill___2W48j{margin-top:-3px;height:22px;font-size:12px;line-height:22px;border-radius:4px;overflow:hidden;background-color:var(--gray-300);color:var(--gray-900);font-family:var(--font-family);cursor:pointer}.table-cell-renderer__relationPill___2W48j>span{display:inline-block;padding:0 5px;box-shadow:var(--shadow-button)}.table-cell-renderer__relationPill___2W48j .table-cell-renderer__relationcount___1mvFe{background:var(--gray-400);font-weight:600}.table-cell-renderer__relationPill___2W48j:hover{background-color:var(--gray-400)}.table-cell-renderer__relationPill___2W48j:hover>span{color:var(--gray-700)}.table-cell-renderer__relationPill___2W48j:hover>span.table-cell-renderer__relationcount___1mvFe{background-color:var(--gray-500);color:var(--black)}.table-cell-renderer__loading___-dzUP{position:relative;opacity:0.2}.table-cell-renderer__loading___-dzUP:before{content:' ';position:absolute;left:0;right:0;margin:9px 12px;height:12px;background-color:var(--gray-500);border-radius:4px}

.string-input__input___1-wqd{height:var(--table-row-height);width:inherit;padding:0 12px}.string-input__input___1-wqd input{font-family:'Roboto Mono';font-size:13px;color:var(--gray-900)}
...
.boolean-input__input___3YpBM{height:var(--table-row-height);width:inherit}

.json-input__input___1tbr_{min-height:var(--table-row-height);width:inherit;line-height:var(--table-row-height);padding:0 12px}.json-input__input___1tbr_ input{font-family:var(--font-family--code);font-size:13px;color:var(--gray-900);white-space:pre}

.table-cell-header-with-search__container___2KMWa{display:flex;flex-direction:column;justify-content:center;padding:0 10px;width:200px;height:inherit;background:var(--gray-800)}.table-cell-header-with-search__title___2kwF5{padding:0 6px;margin-bottom:8px}.table-cell-header-with-search__input___3UWrR{border-radius:4px;background-color:var(--gray-900);color:var(--gray-600);padding:5px;border:none;height:27px;outline:none}.table-cell-header-with-search__input___3UWrR:focus{box-shadow:0 0 0 1px var(--blue-400)}.table-cell-header-with-search__input___3UWrR::placeholder{color:var(--gray-600)}.table-cell-header-with-search__inputPlaceholder___11Q2P{height:27px}

.relation-input__container___1WXtC{position:relative;height:var(--table-row-height);padding:0 12px;display:flex;align-items:center}.relation-input__relation___2BXKr{margin-top:-3px;height:22px;font-size:12px;line-height:22px;border-radius:4px;overflow:hidden;background-color:var(--gray-700);color:var(--gray-300);font-family:var(--font-family);cursor:pointer}.relation-input__relation___2BXKr>span{display:inline-block;padding:0 5px;box-shadow:var(--shadow-button)}.relation-input__relation___2BXKr .relation-input__relationcount___2tD6l{background:var(--gray-800);font-weight:600}.relation-input__table___1Dvdg{display:flex;flex-direction:column;padding:0;position:absolute;outline:none;list-style:none;border-radius:8px;overflow:hidden;box-shadow:var(--shadow-bold)}.relation-input__footer___3RPIW{display:flex;align-items:center;background-color:var(--gray-800);flex:0 0 36px;border-top:1px solid var(--gray-900)}.relation-input__footer___3RPIW .relation-input__footerBtn___Avpvw{background-color:transparent;border:none;outline:none;color:var(--gray-500);text-decoration:underline;margin:0 10px;cursor:pointer}.relation-input__footer___3RPIW .relation-input__footerBtn___Avpvw.relation-input__disabled___2ZR-k{cursor:not-allowed}

.string-list-input__container___3C7YP{display:flex;position:relative;height:var(--table-row-height);width:inherit}.string-list-input__input___GYVaG{font-family:var(--font-family--code);font-size:14px;padding:0;margin:0;border:0;outline:none;flex:1;padding:0 17px}.string-list-input__text___1G-5O{display:block;font-family:var(--font-family--code);font-size:14px;margin:5px 0}.string-list-input__dropdown___3patO{display:flex;flex-direction:column;margin:0;padding:10px;position:absolute;top:40px;left:0;right:0;outline:none;list-style:none;border-radius:4px;border-top-left-radius:0;border-top-right-radius:0;background-color:var(--white);box-shadow:var(--shadow-bold)}.string-list-input__dropdown___3patO .string-list-input__item___2P1do{display:flex;align-items:flex-end;padding:0 15px}.string-list-input__dropdown___3patO .string-list-input__item___2P1do.string-list-input__hidden___SPIVP{display:none}.string-list-input__dropdown___3patO .string-list-input__item___2P1do .string-list-input__input___GYVaG{height:40px;width:100%;border:1px solid var(--gray-300)}.string-list-input__dropdown___3patO .string-list-input__item___2P1do .string-list-input__text___1G-5O{margin-left:5px}

.table-cell-editor__container___54prs{height:inherit;width:inherit}

.table__container___1WFQ4{height:100%}.table__lastUncommittedRow___ZUqne{border-bottom:2px solid var(--gray-400) !important}

.infinite-list__stickyItems___27eaq{position:sticky;top:0;z-index:var(--z-index--table-sticky);background:var(--white)}.infinite-list__outer___GEkBh{outline:none}
...
.tree-row-object__container___tiqPF{display:grid;grid-template-rows:23px auto;grid-template-columns:min-content 16px min-content min-content;outline:none;cursor:pointer}.tree-row-object__container___tiqPF .tree-row-object__meta___3T6oK{border:1px solid transparent;border-right:none;border-radius:3px 0 0 3px}.tree-row-object__container___tiqPF .tree-row-object__fieldValue___1MRLp{border:1px solid transparent;border-left:none !important;border-radius:0 3px 3px 0}.tree-row-object__container___tiqPF.tree-row-object__active___2Q43x .tree-row-object__meta___3T6oK{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500);border-right:none}.tree-row-object__container___tiqPF.tree-row-object__active___2Q43x .tree-row-object__fieldValue___1MRLp{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500)}.tree-row-object__container___tiqPF.tree-row-object__expanded___3O-JY .tree-row-object__expandButton___RAtuw svg{transform:rotate(90deg)}.tree-row-object__container___tiqPF.tree-row-object__expanded___3O-JY .tree-row-object__fieldValue___1MRLp{grid-row-start:2;grid-column-start:2;grid-column-end:4}.tree-row-object__expandButton___RAtuw{display:flex;align-items:center}.tree-row-object__expandButton___RAtuw:hover svg{fill:var(--gray-800)}.tree-row-object__expandButton___RAtuw svg{width:8px;height:8px;fill:var(--gray-600);transition:0.2s}.tree-row-object__loader___fBBjz{width:18px}.tree-row-object__meta___3T6oK{display:flex;align-items:center;border:1px solid transparent}.tree-row-object__meta___3T6oK.tree-row-object__active___2Q43x{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500);border-radius:3px}.tree-row-object__meta___3T6oK .tree-row-object__icon___3MDEZ{margin-right:10px}.tree-row-object__meta___3T6oK .tree-row-object__fieldName___1dIuL{color:var(--blue-900);user-select:text;margin-right:5px}.tree-row-object__meta___3T6oK .tree-row-object__fieldType___27hAV{color:var(--blue-500);margin-right:10px}.tree-row-object__fieldValue___1MRLp{color:var(--gray-600);user-select:text;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}

.tree-row-array__container___NgqRN{display:grid;grid-template-rows:23px auto;grid-template-columns:min-content 16px min-content min-content;outline:none;cursor:pointer}.tree-row-array__container___NgqRN .tree-row-array__meta___1CqZk{border:1px solid transparent;border-right:none;border-radius:3px 0 0 3px}.tree-row-array__container___NgqRN .tree-row-array__fieldValue___1julL{border:1px solid transparent;border-left:none !important;border-radius:0 3px 3px 0}.tree-row-array__container___NgqRN.tree-row-array__active___a1hP0 .tree-row-array__meta___1CqZk{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500);border-right:none}.tree-row-array__container___NgqRN.tree-row-array__active___a1hP0 .tree-row-array__fieldValue___1julL{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500)}.tree-row-array__container___NgqRN.tree-row-array__expanded___baMMz>.tree-row-array__expandButton___2NbJA svg{transform:rotate(90deg)}.tree-row-array__container___NgqRN.tree-row-array__expanded___baMMz>.tree-row-array__fieldValue___1julL{grid-row-start:2;grid-column-start:2;grid-column-end:4}.tree-row-array__expandButton___2NbJA{display:flex;align-items:center}.tree-row-array__expandButton___2NbJA:hover svg{fill:var(--gray-800)}.tree-row-array__expandButton___2NbJA svg{width:8px;height:8px;fill:var(--gray-600);transition:0.2s}.tree-row-array__loader___28ua9{width:18px}.tree-row-array__meta___1CqZk{display:flex;align-items:center;border:1px solid transparent}.tree-row-array__meta___1CqZk.tree-row-array__active___a1hP0{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500);border-radius:3px}.tree-row-array__meta___1CqZk .tree-row-array__icon___13WUm{margin-right:10px}.tree-row-array__meta___1CqZk .tree-row-array__fieldName___2niPB{color:var(--blue-900);user-select:text;margin-right:5px;white-space:nowrap}.tree-row-array__meta___1CqZk .tree-row-array__fieldType___BvV14{color:var(--blue-500);margin-right:10px}.tree-row-array__fieldValue___1julL{color:var(--gray-600);user-select:text;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}

.tree-row-scalar__container___39WF3{display:grid;grid-template-rows:23px;grid-template-columns:min-content 16px min-content min-content;outline:none}.tree-row-scalar__container___39WF3 .tree-row-scalar__meta___29Ap5{border:1px solid transparent;border-right:none;border-top-left-radius:3px;border-bottom-left-radius:3px}.tree-row-scalar__container___39WF3 .tree-row-scalar__fieldValue___2Pozq{border:1px solid transparent;border-left:none;border-top-right-radius:3px;border-bottom-right-radius:3px}.tree-row-scalar__container___39WF3.tree-row-scalar__active___1vV1h .tree-row-scalar__meta___29Ap5{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500);border-right:none}.tree-row-scalar__container___39WF3.tree-row-scalar__active___1vV1h .tree-row-scalar__fieldValue___2Pozq{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500);border-left:none}.tree-row-scalar__meta___29Ap5{display:flex;align-items:center;grid-column-start:3}.tree-row-scalar__meta___29Ap5 .tree-row-scalar__icon___3C_cB{margin-right:10px}.tree-row-scalar__meta___29Ap5 .tree-row-scalar__fieldName___1MOJv{color:var(--blue-900);user-select:text;margin-right:5px}.tree-row-scalar__fieldValue___2Pozq{color:var(--red-500);overflow:hidden;white-space:nowrap;text-overflow:ellipsis;user-select:text}

.tree-row-enum__container___3qlvX{display:grid;grid-template-rows:23px;grid-template-columns:min-content 16px min-content min-content;outline:none}.tree-row-enum__container___3qlvX .tree-row-enum__meta___1N38A{border:1px solid transparent;border-right:none;border-top-left-radius:3px;border-bottom-left-radius:3px}.tree-row-enum__container___3qlvX .tree-row-enum__fieldValue___2jNj9{border:1px solid transparent;border-left:none;border-top-right-radius:3px;border-bottom-right-radius:3px}.tree-row-enum__container___3qlvX.tree-row-enum__active___24OEt .tree-row-enum__meta___1N38A{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500);border-right:none}.tree-row-enum__container___3qlvX.tree-row-enum__active___24OEt .tree-row-enum__fieldValue___2jNj9{background-color:var(--active-item-highlight-color);border:1px solid var(--blue-500);border-left:none}.tree-row-enum__meta___1N38A{display:flex;align-items:center;grid-column-start:3}.tree-row-enum__meta___1N38A .tree-row-enum__icon___2bEwH{margin-right:10px}.tree-row-enum__meta___1N38A .tree-row-enum__fieldName____cz8S{color:var(--blue-900);user-select:text;margin-right:5px}.tree-row-enum__fieldValue___2jNj9{color:var(--red-500);overflow:hidden;white-space:nowrap;text-overflow:ellipsis;user-select:text}
...
.model-list-tab__container___2iQfz{display:flex;justify-content:center;background-color:var(--white);height:100%;flex:1}.model-list-tab__content___18lyk{display:flex;flex-direction:column;margin:24px 0;flex:0.4 1 0;max-width:480px;border:1px solid var(--gray-300);border-radius:8px}.model-list-tab__header___2qZiM{padding:40px 40px 0 40px}.model-list-tab__title___26jdJ{font-size:18px;font-weight:600;text-align:center}.model-list-tab__search___3P72x{background-color:var(--gray-300);margin:20px 0;height:36px;padding:0 12px;border-radius:4px}.model-list-tab__search___3P72x input{font-size:var(--font-size-control)}.model-list-tab__section___tpUs2{border-top:1px solid var(--gray-300);padding:24px 40px 40px 40px}.model-list-tab__section___tpUs2.model-list-tab__allModels___19QwC{flex:1;overflow:auto}.model-list-tab__sectionTitle___3UTvk{font-weight:600;margin-bottom:12px}.model-list-tab__list___ypFQI{padding:0;margin:0}.model-list-tab__model___2e6Vy{display:flex;font-size:var(--font-size-control);padding:4px 10px;margin:2px -10px}.model-list-tab__model___2e6Vy:hover,.model-list-tab__model___2e6Vy.model-list-tab__active___2uFbZ{background-color:var(--gray-200);border-radius:4px;cursor:pointer}.model-list-tab__model___2e6Vy .model-list-tab__spacer___vRes_{flex:1}.model-list-tab__model___2e6Vy .model-list-tab__count___2D01o{color:var(--gray-400)}.model-list-tab__empty___3Y9GX{color:var(--gray-600)}
...
.key__container___2x1cY{display:flex;align-items:center;justify-content:center;padding:5px;margin:0 3px;min-width:24px;height:24px;font-size:var(--font-size-normal);font-weight:600;background-color:var(--gray-200);color:var(--gray-700);border-radius:4px;box-shadow:3px 3px 0 var(--gray-400)}

.shortcut-dialog__container___2Uj92{display:flex;flex-direction:column;width:400px;height:630px;background-color:var(--gray-200)}.shortcut-dialog__title___35LJu{font-size:14px;font-weight:600;margin:10px}.shortcut-dialog__content___JX2dC{flex:1;overflow-y:scroll;padding:10px;padding-top:0}.shortcut-dialog__section___qIMbC{display:flex;flex-direction:column;padding:10px;margin-bottom:10px}.shortcut-dialog__section___qIMbC:last-child{margin-bottom:0}.shortcut-dialog__section___qIMbC .shortcut-dialog__sectionName___gQWtp{font-size:14px;font-weight:600;margin-bottom:10px}.shortcut-dialog__row___GU8Z7{display:flex;align-items:center;margin-bottom:10px}.shortcut-dialog__row___GU8Z7 .shortcut-dialog__name___Geqvf{flex:1;font-size:var(--font-size-normal)}.shortcut-dialog__row___GU8Z7 .shortcut-dialog__keys___3ARYB{display:flex;align-items:center;margin-left:10px;font-size:14px}.shortcut-dialog__row___GU8Z7 .shortcut-dialog__keys___3ARYB .shortcut-dialog__separator___3QFiT{margin:0 3px}
...
.label__container___1-ZPT{margin:0 0 8px 4px;height:20px;display:flex}.label__container___1-ZPT:hover .label__actions___H0CUW{display:flex}.label__label___26xNs{display:block;color:var(--gray-900);font-size:12px;font-weight:600;margin-right:5px}.label__annotation___254Yv{color:var(--gray-600);font-size:12px}.label__spacing___3_wh8{flex:1}.label__actions___H0CUW{display:none}

.file-picker__container___1ZwkE{display:flex;flex-direction:column;position:relative}.file-picker__input___1SgiU{height:34px;z-index:0;outline:none;border:0;flex:1;opacity:0;cursor:pointer}.file-picker__filename___6A19_{position:absolute;top:27px;left:0;right:0;display:flex;align-items:center;flex:0 0 24px;background-color:var(--gray-200);color:var(--gray-800);font-size:14px;line-height:1;height:34px;border-radius:4px;padding:8px 12px}.file-picker__filename___6A19_ span{flex:1}.file-picker__filename___6A19_ svg{width:18px;height:16px;fill:var(--gray-600)}

.create-project__container___2DIW6{display:flex;flex-direction:column;flex:1;margin:15px;-webkit-app-region:drag}.create-project__content___1SU_8{display:flex;flex-direction:column;overflow-y:scroll;-webkit-app-region:no-drag}.create-project__title___343-n{text-align:center;color:var(--gray-900);margin:20px 0;font-size:15px;font-weight:600}.create-project__input___2qU26{flex:1}.create-project__input___2qU26 input{background-color:var(--gray-200);border-radius:4px;padding:10px;height:35px;border:2px solid transparent}.create-project__input___2qU26 input:focus{border:2px solid var(--blue-500)}.create-project__uri___2GOja{border-bottom:1px solid var(--gray-200);margin-bottom:20px;padding:15px 15px 20px 15px}.create-project__uri___2GOja.create-project__input___2qU26{flex:0 0 95px}.create-project__host___1nx9S.create-project__input___2qU26{flex:3}.create-project__dbTypeCard___3L-YK{flex:0 0 96px;padding:15px;margin-bottom:10px;-webkit-app-region:no-drag}.create-project__projectCard___oD_7y{display:flex;flex-direction:column;-webkit-app-region:no-drag;margin-bottom:10px}.create-project__row___192qd{display:flex;padding:0 15px;margin-bottom:20px}.create-project__row___192qd.create-project__multipleCellRow___RiV7q>div:first-child{margin-right:15px}.create-project__saveCard___16hl5{flex:0 0 50px;margin-bottom:10px;display:flex;flex-direction:column}.create-project__saveCard___16hl5.create-project__open___2NBzV{flex:0 0 230px}.create-project__saveCard___16hl5 .create-project__row___192qd{flex:0 0 50px}.create-project__saveCard___16hl5 .create-project__row___192qd:first-child{border-bottom:1px solid var(--gray-200)}.create-project__saveCard___16hl5 .create-project__row___192qd>div{flex:1}.create-project__filepicker___ybnfE{flex:1}.create-project__error___1b5cM{color:#ff4f56;margin-bottom:10px;transform:translateY(-7px);padding:0 30px;flex:0 0 20px}.create-project__footer___1-F6h{flex:0 0 30px;display:flex;justify-content:space-between;align-items:center;padding:0 15px;margin-bottom:10px}.create-project__button___2scOE{background-color:var(--gray-800);padding:10px}
