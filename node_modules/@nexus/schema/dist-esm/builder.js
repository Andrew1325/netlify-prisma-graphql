...
import { assertNoMissingTypes, casesHandled, consoleWarn, eachObj, firstDefined, isObject, mapValues, objValues, UNKNOWN_TYPE_SCALAR, validateOnInstallHookResult, } from './utils';
const SCALARS = {
...
export class SchemaBuilder {
    constructor(config) {
        ...
        this.nonNullDefaults = Object.assign({ input: false, output: false }, config.nonNullDefaults);
    ...
    outputNonNull(typeDef, field) {
        ...
        const { nonNullDefaults = {} } = (_c = (_b = (_a = typeDef.extensions) === null || _a === void 0 ? void 0 : _a.nexus) === null || _b === void 0 ? void 0 : _b.config) !== null && _c !== void 0 ? _c : {};
        if (typeof nullable !== 'undefined') {
            return !nullable;
        }
        // Non-Null by default
